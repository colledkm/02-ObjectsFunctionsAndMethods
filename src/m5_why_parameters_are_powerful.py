...
def better_draw_circles(point,radii_scale):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN 15 pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(radii_scale)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(radii_scale * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point,radii_scale,number_of_circles,color,thickness):
